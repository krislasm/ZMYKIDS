sap.ui.define([
		...
		return BaseObject.extend("swa.mykids.model.ListSelector", {
			 ...
			 * @class
			 * @public
			 * @alias swa.mykids.model.ListSelector
			 */
			 ...
			 * @return {swa.mykids.model.ListSelector} the list selector object for method chaining
			 * @public
			 */
