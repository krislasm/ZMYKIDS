sap.ui.define([
		...
		function getFrameUrl (sHash, sUrlParameters) {
			var sUrl = jQuery.sap.getResourcePath("swa/mykids/app", ".html");
			sHash = sHash || "";
		...
		return Opa5.extend("swa.mykids.test.integration.pages.Common", {
			...
			getMockServer : function () {
				return new Promise(function (success) {
					Opa5.getWindow().sap.ui.require(["swa/mykids/localService/mockserver"], function (mockserver) {
